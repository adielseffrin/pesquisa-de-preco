    ...
    <h3 id="titulo">Pesquisa de preço</h3>
	  <nav class="navbar navbar-light bg-light">
		...
		<div class="container app">
            ...
            <li class="list-group-item"><a href="./pesquisapublica/pesquisa.php">Pesquisa</a></li>
					</ul>
				</div>
				<div class="col-md-9">
                ...
                <form method="POST" action="./privado/selecao.php">     
                  ...
                  if(count($resultado) > 0){
                    ...
                    echo "<button class='btn btn-success' name='selecao'>Selecionar</button><br/><br/>";
                  }else{
                    echo "<div class='form-check'>Nenhum registro encontrado</div>";
                  }
                  ?>
                          
                </form>
			          <form method="POST" action="./privado/pesquisa.php"></form> 
              </div>
						</div>
					</div>
				</div>
